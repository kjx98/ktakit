...
int      main()
{
    ...
    taChart(&b1.vol, taNULLBARS, xstart, xstop, width, 0, volmax * 4, x1, y1,
            x2, y2, taCHART_HIST, taBRIGHTCYAN, 0, 0x1248);
    taChart(&ma1, taNULLBARS, xstart, xstop, width, ystart, ystop, x1, y1,
            x2, y2, taCHART_LINE, taBRIGHTMAGENTA, 0, taSOLID);
    taChart(&ma2, taNULLBARS, xstart, xstop, width, ystart, ystop, x1, y1,
            x2, y2, taCHART_LINE, taYELLOW, 0, 0xFFF0);
    taChart(&ma3, taNULLBARS, xstart, xstop, width, ystart, ystop, x1, y1,
            x2, y2, taCHART_POINT, taBRIGHTBLUE, 0, 0);
    taChart(taNULLARRAY, &b1, xstart, xstop, width, ystart, ystop, x1, y1,
            x2, y2, taCHART_OPHILOCL, taBRIGHTWHITE, 0, 0);
    /* taChart(taNULLARRAY, &b1, xstart, xstop, width, ystart, ystop, x1, y1,
            x2, y2, taCHART_CANDLE, taBRIGHTWHITE, taBRIGHTWHITE, taBLACK); */
