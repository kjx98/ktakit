...
static void	des_round(int num,unsigned long *block);
...
static	void
des_round(int num,unsigned long *block)
...
static
long
f(unsigned long r,unsigned char subkey[8])
...
//unsigned char subkey[8];	  /* 48-bit key for this round */
{
	...
	warn("f(%08lx, %02x %02x %02x %02x %02x %02x %02x %02x) = ",
		r,
...
static void
perminit(char perm[16][16][8],char p[64])
